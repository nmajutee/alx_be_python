...
match priority:
    ...
    case "medium":
        if time_bound == "yes":
            ...
            print(f"Reminder: {task} is a medium-priority task. Complete it when feasible.")
    case "low":
        if time_bound == "yes":
            print(f"Reminder: {task} is a low-priority task but has a deadline, so don't delay too long!")
        else:
